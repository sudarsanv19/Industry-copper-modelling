...
with tab1:
    ...
    if submit_button and flag == 0:
        ...
        with open(r"C:\\Users\\sudarsan\\Downloads\\model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r"C:\\Users\\sudarsan\\Downloads\\scaler.pkl", 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r"C:\\Users\\sudarsan\\Downloads\\t.pkl", 'rb') as g:
            t_loaded = pickle.load(g)

        with open(r"C:\\Users\\sudarsan\\Downloads\\s.pkl", 'rb') as h:
            s_loaded = pickle.load(h)
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"C:\\Users\\sudarsan\\Downloads\\cmodel.pkl", 'rb') as file1:
            cloaded_model = pickle.load(file1)

        with open(r"C:\\Users\\sudarsan\\Downloads\\cscaler.pkl", 'rb') as f1:
            cscaler_loaded = pickle.load(f1)

        with open(r"C:\\Users\\sudarsan\\Downloads\\ct.pkl", 'rb') as g1:
            ct_loaded = pickle.load(g1)
...
st.write(f'<h6 style="color:#ee4647;">App Created by Sudarsan V</h6>', unsafe_allow_html=True)